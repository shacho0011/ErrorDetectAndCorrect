 ...
 * @author Shadhin
 */
public class XMLReaderMaster {

    int i;
    String filePath = "E:\\Education\\4.1\\thesis\\BART-Datasets\\customers-200k\\xml\\200k_master.xml";
        ...
        try {
            ...
            for (i = 0; i < nList.getLength(); i++) {
                ...
                if (node.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    insert.insertMaster(ssn, name, phone, street, city);
